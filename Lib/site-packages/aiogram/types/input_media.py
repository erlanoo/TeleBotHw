...
class InputMedia(base.TelegramObject):
    ...
    def _media_changed(self, value):
        if (
            ...
            and not value.startswith("attach://")
        ):
            self._media_file = None
...
class MediaGroup(base.TelegramObject):
    ...
    def __init__(
        self,
        medias: typing.Optional[
            typing.List[typing.Union[InputMedia, typing.Dict]]
        ] = None,
    ):
    ...
    def attach_audio(
        self,
        audio: typing.Union[InputMediaAudio, base.InputFile],
        thumb: typing.Union[base.InputFile, base.String] = None,
        caption: base.String = None,
        duration: base.Integer = None,
        performer: base.String = None,
    ...
    def attach_document(
        self,
        document: typing.Union[InputMediaDocument, base.InputFile],
        thumb: typing.Union[base.InputFile, base.String] = None,
        caption: base.String = None,
        parse_mode: base.String = None,
        caption_entities: typing.Optional[typing.List[MessageEntity]] = None,
    ...
    def attach_photo(
        self,
        photo: typing.Union[InputMediaPhoto, base.InputFile],
        caption: base.String = None,
        parse_mode: base.String = None,
        caption_entities: typing.Optional[typing.List[MessageEntity]] = None,
    ):
